-- ESS Tester Database Schema
-- The ess_tester database is already created by POSTGRES_DB environment variable
-- This script creates the tables and schema

-- Explicitly connect to ess_tester database
\c ess_tester
...
CREATE TABLE device_nameplates (
    mrid UUID NOT NULL PRIMARY KEY,
    capacity DOUBLE PRECISION,
    real_power DOUBLE PRECISION,
    reactive_power DOUBLE PRECISION,
    reactive_power_generation DOUBLE PRECISION,
    reactive_power_absorption DOUBLE PRECISION,
