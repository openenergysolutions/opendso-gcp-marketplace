...
IMAGE_SPECS=(
    ...
    "citusdata/citus|citusdata/citus|14.0.0-alpine|global.images.citusDb|digest"
    "timescale/timescaledb|timescale/timescaledb|2.28.0-pg16|global.images.appsDb|digest"
