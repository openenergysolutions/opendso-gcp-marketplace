...
IMAGE_SPECS=(
    ...
    "cvr|d82e76f7|global.images.cvrSvc"
    "genetic-cvr|3caaba18|global.images.cvrGeneticAlgorithmSvc"
    "openfmb-services|983c2e4b|global.images.cvrOpenfmbServicesSvc"
