...
IMAGE_SPECS=(
    ...
    "data-viewer-app|latest|global.images.dataViewerApp"
    "edo-adr-app|latest|global.images.scheduleDispatchApp"
    "event-viewer-app|latest|global.images.eventViewerApp"
    "gis-app|latest|global.images.gisApp"
    "historian-app|latest|global.images.historianApp"
    "inspector-app|latest|global.images.inspectorApp"
    "inventory-app|latest|global.images.inventoryApp"
    "one-line-app|latest|global.images.oneLineApp"
    "opendso-docs|latest|global.images.opendsoDocsApp"
    "openfmb-event-creator-app|latest|global.images.openfmbEventCreatorApp"
    "ess-manager|latest|global.images.essManagerSvc"
    "ess-manager-app|latest|global.images.essManagerApp"
    "ess-tester|3adda1cd|global.images.essTesterSvc"
